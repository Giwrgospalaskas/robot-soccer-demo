...
class SoccerSimulator():
    ...
    def step(self):
        ...
        TeamAPolicy = self.policy[0]
        TeamBPolicy = self.policy[1]
        ...
        actionsA.extend(TeamAPolicy.compute_actions(self.teamA,self.teamB,self.ball,self.goalB))
        actionsB.extend(TeamBPolicy.compute_actions(self.teamB,self.teamA,self.ball,self.goalA))
